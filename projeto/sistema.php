...
<body>
    ...
    <div>
        <a href=""></a>
        <a href="formulario.php">Entrada</a>
    ...
    <div class="box-search">
        ...
        <svg xmins="http://www.w3.otg/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1,397 1398h-.00113.85 385a1 0 0 0 1.415-1.4141-3.85zm-5.44.99.69a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0--11z"></path> </svg>
        </button>
    </div>
    <div class="m-5">
